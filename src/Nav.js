    ...
    return (
        <div className="navbar">
            ...
            <div className="navbar_inner" >
                <div className="navbar_company_name" ><h1><h1>ATG.</h1>W<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="search_bar" >
                    <label htmlFor="search" ><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 className="createAcc" onClick={() => { props.popup() }}>Create account. <h1>It's free!</h1></h1>
